...
class Util_Crawler_Result {
    ...
    public function & get($name, $default = null){
        if (array_key_exists($name, $this->parameters)){
            ...
            $value = Util_Crawler_Tool::getArrayValueForPath($this->parameters, $name, $default);
        }
    ...
    public function has($name){
        if (array_key_exists($name, $this->parameters)){
            ...
            return Util_Crawler_Tool::hasArrayValueForPath($this->parameters, $name);
        }
    ...
    public function remove($name, $default = null){
        ...
        if (array_key_exists($name, $this->parameters)){
            ...
            $retval = Util_Crawler_Tool::removeArrayValueForPath($this->parameters, $name, $default);
        }
