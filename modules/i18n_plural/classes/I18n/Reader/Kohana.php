...
class I18n_Reader_Kohana implements I18n_Reader_ReaderInterface {

	private $cache = array();
	private $directory;
	private $cntAvdFiles = 0;
	...
	{
	    if (count($advs = I18n_Core::getInstance()->getAdvFile()) != $this->cntAvdFiles){
		...
		if (count($advs = I18n_Core::getInstance()->getAdvFile())){
		    foreach ($advs as $adv){
		        $files = Kohana::find_file($this->directory . DIRECTORY_SEPARATOR . $lang, $adv, NULL, TRUE);
