...
class I18n_Core
{
	...
	/**
	 * @var  I18n_Plural_Factory
	 */
	private $_plural_rules_factory;
	
	private $_advFile = array();
	...
	public function addAdvFile($advFile){
	    if (!in_array($advFile, $this->_advFile)){
	        $this->_advFile[] = $advFile;
	    }
	}
	
	public function getAdvFile(){
	 ...
	 */
	public function attach(I18n_Reader_ReaderInterface $reader)
	{
	...
	/**
	 * @return  I18n_Plural_Factory
	 */
	protected function plural_rules_factory()
	{
		if ($this->_plural_rules_factory === NULL)
		{
			$this->_plural_rules_factory = new I18n_Plural_Factory;
		}
