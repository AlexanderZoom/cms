...
<div class="col-lg-12">
 ...
 <div class="form-group">
      <label><?php echo ___('Nickname'); ?></label>
      <p class="help-block help-block-error"><?php if (isset($errors['nickname'])) echo $errors['nickname']; ?></p>
      <input type="text" class="form-control" name="nickname" value="<?php echo HTML::entities(Arr::get($data, 'nickname')); ?>"
      >
</div>

 <div class="form-group">
      <label><?php echo ___('First Name'); ?></label>
      <p class="help-block help-block-error"><?php if (isset($errors['firstname'])) echo $errors['firstname']; ?></p>
      <input type="text" class="form-control" name="firstname" value="<?php echo HTML::entities(Arr::get($data, 'firstname')); ?>"
      >
</div>

 <div class="form-group">
      <label><?php echo ___('Last Name'); ?></label>
      <p class="help-block help-block-error"><?php if (isset($errors['lastname'])) echo $errors['lastname']; ?></p>
      <input type="text" class="form-control" name="lastname" value="<?php echo HTML::entities(Arr::get($data, 'lastname')); ?>"
      >
</div>

<div class="form-group">
	<label  for="birthday"><?php echo ___('Birthday'); ?></label>
    <p class="help-block help-block-error"><?php if (isset($errors['birthday'])) echo $errors['birthday']; ?></p>
    <input type="text" class="form-control" id="birthday" name="birthday" value="<?php echo HTML::entities(Arr::get($data, 'birthday')); ?>" >                        
                      </div>
