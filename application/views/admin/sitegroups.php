...
function submit_form(action, id){
	...
	var actionCreate = '<?php echo URL::site(Route::url('admin', array('controller'=>'siteGroups', 'lang' => $lang, 'action'=>'create')));?>';
	var actionEdit = '<?php echo URL::site(Route::url('admin', array('controller'=>'siteGroups', 'lang' => $lang, 'action'=>'edit')));?>';
	var actionDelete = '<?php echo URL::site(Route::url('admin', array('controller'=>'siteGroups', 'lang' => $lang, 'action'=>'delete')));?>';
	var actionAccess = '<?php echo URL::site(Route::url('admin', array('controller'=>'siteAccess', 'lang' => $lang, 'action'=>'index')));?>';
