...
function submit_form(action, id){
	...
	var actionCreate = '<?php echo URL::site(Route::url('admin', array('controller'=>'siteUsers', 'lang' => $lang, 'action'=>'create')));?>';
	var actionEdit = '<?php echo URL::site(Route::url('admin', array('controller'=>'siteUsers', 'lang' => $lang, 'action'=>'edit')));?>';
	var actionDelete = '<?php echo URL::site(Route::url('admin', array('controller'=>'siteUsers', 'lang' => $lang, 'action'=>'delete')));?>';
