...
class Admin_Access {
	...
	const ACCESS_RESERVED1 = 0x20;
	const ACCESS_RESERVED2 = 0x40;
	const ACCESS_RESERVED3 = 0x80;
	const ACCESS_RESERVED4 = 0x100;
	
	protected static $tblGroupAccess = 'admin_group_access';
	...
	public static function getAccessClasses(){
		return Modules::getAccessClasses();
	}
	...
	public static function getListAccess(){
		...
		$listAccessClasses = Modules::getAccessClasses();
