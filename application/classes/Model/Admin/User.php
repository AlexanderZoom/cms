...
class Model_Admin_User extends ORM {
    ...
    public function labels(){
        return array(
        'login' => ___('model.admin_user.login'),
        'password' => ___('model.admin_user.password'),
        'password_salt' => ___('model.admin_user.password_salt'),
        'is_disabled' => ___('model.admin_user.is_disabled'),
    ...
    public function hasGroup($group, $cache = true){
        ...
        if (is_array($group)){
            foreach ($group as $groupItem){
                if ($groupItem instanceof Model_Admin_Group){
        ...
        elseif ($group instanceof Model_Admin_Group){
