...
return array(
    'media_storage' => array(
        'fields' => array(
            'token'      => 'Токен',
            'data_type'  => 'Тип хранения данных',
            'created_at' => 'Дата создания',
            'updated_at' => 'Дата создания',
            'expire_at'  => 'Дата годности',
            'action'     => 'Действие',
            'name'       => 'Имя',
            'id'         => 'Id',
            'parent_id'  => 'Id родительского объекта',
            'category_code' => 'Имя категории',
            'ip'            => 'Ip',
            'location_code' => 'Имя места коллекции',
            'vfolder_id' => 'Имя виртуальной папки',
            'location_path' => 'Путь в месте коллекции',
            'file_name' => 'Реальное имя файа',
            'file_extension' => 'Расширение файла',
            'file_size' => 'Размер файла',
            'file_mime' => 'Мим тип файла',
            'file_id' => 'Id файла',
            ...
            'category' => array(
                ...
                'code' => 'Название категории'
            ),
        
            'vfolder' => array(
                'name' => 'Имя папки',
                'parent_id' => 'Имя родительской папки'
            ),
        
            'reservedsize' => array(
                'unique_id' => 'Уникальный хэш'
            ),
	...
	'valid' => array(
	    ...
	    'not_empty_all' => 'Поле :field должно быть заполнено',
	    ...
	    'in'			=> 'Поле :field не соответствует списку',
	    'check_password'			=> 'Поле :field не совпадает повторному паролю',
	),
);