...
INSERT INTO `admin_user` (`id`, `login`, `password`, `password_salt`, `is_disabled`, `last_login`, `last_ip`, `last_ip_forward`, `created_at`, `updated_at`) VALUES
  (1,'zoomerev@gmail.com','5d573efa40477813cf62d1d4b27de3e2','f450551be3',0,'2016-09-18 03:34:19','127.0.0.1','91.108.63.79','2013-11-30 10:15:28','2016-09-18 03:34:19'),
...
INSERT INTO `setting` (`code`, `value`, `created_at`, `updated_at`) VALUES
  ('admin.module.pro.stat','2345667','2016-06-16 02:08:08','2016-09-17 23:32:55'),
  ...
  ('site.main.register_type','verification','2016-09-14 02:16:48','2016-09-18 08:02:29'),
...
INSERT INTO `site_menu` (`id`, `name`, `url`, `target`, `parent`, `position`, `created_at`, `updated_at`) VALUES
  (1,'root','root','self',NULL,3,'2016-09-09 19:13:16','2016-09-09 21:34:53'),
  (2,'home','/','self',3,1,'2016-09-09 20:04:15','2016-09-09 23:30:39'),
  (3,'TOPMENU','TOPMENU','self',NULL,1,'2016-09-09 22:31:34','2016-09-10 00:40:27'),
  ...
  (9,'fun','/fun','self',3,7,'2016-09-10 03:12:32','2016-09-10 03:12:32'),
  (13,'go','/go','self',1,1,'2016-09-12 03:08:48','2016-09-12 03:10:50'),
  (14,'next','/next','self',13,1,'2016-09-12 03:09:09','2016-09-12 03:09:09'),
  (15,'to','/to','self',14,1,'2016-09-12 03:09:29','2016-09-12 03:09:29'),
  (16,'hell','/hell','self',15,1,'2016-09-12 03:09:53','2016-09-12 03:11:13'),
  (17,'Sign in','/login','self',3,127,'2016-09-14 08:00:17','2016-09-14 08:00:17');
COMMIT;
...
INSERT INTO `site_session` (`session_id`, `last_active`, `contents`) VALUES
  ...
  ('57de22c69b0916-87133039',1474175686,'VnVjjVILzpeprRdYrRtlvzZVv7JFcKfsXcJmPDyryJVg5qXSFOVapVMsGou3urzLMr1RWtrsCqicB/J5uBBPYzdzOs2+NKtZlJI=');
COMMIT;
...
INSERT INTO `site_user` (`id`, `login`, `password`, `password_salt`, `is_disabled`, `nickname`, `firstname`, `lastname`, `birthday`, `last_login`, `last_ip`, `last_ip_forward`, `created_at`, `updated_at`) VALUES
  (1,'geroys','f7d2924a3d5e09da5fa5f9d3a0eeaeab','f8c78e0d3a',0,'AZoom','Alexander','Zoom','1982-06-12','2016-09-18 03:30:25','127.0.0.1','91.108.63.79','2016-09-06 00:11:56','2016-09-18 03:30:25'),
  (2,'alexazoom','0f4a407aefd0404fea4bb6690b5c5897','1a876cb9e2',0,'','','','1900-12-21',NULL,NULL,NULL,'2016-09-06 00:47:46','2016-09-06 02:03:53'),
  ...
  (12,'geroyster@gmail.com','a2197439a92202f8eec011909aef8bbd','91c07388f7',0,'AZoom',NULL,NULL,NULL,'2016-09-18 08:14:42','127.0.0.1','91.108.63.79','2016-09-18 08:14:10','2016-09-18 08:14:42');
COMMIT;
